          ...
          <div className="w-full max-w-[full] mx-auto h-auto  flex flex-col lg:flex-row lg:justify-between lg:items-center gap-6 md:gap-8 lg:gap-0">
            ...
            <div className="w-full lg:w-[560px] h-auto  flex flex-col gap-4">
              ...
              <div className="text-center flex">
                <div
                  data-animate-item
                  className="inline-flex items-center font-['Manrope'] font-bold justify-center gap-[6px] rounded-[50px] bg-[#F6F6F6] w-[207px] h-[49px] px-2 py-2 text-[18px] leading-[18px] font-semibold text-[#132436] capitalize"
                >
              ...
              <div className="w-[auto] sm:w-[654px] h-auto lg:min-h-[164px] flex flex-col ">
                ...
                <div className="flex items-center flex-wrap gap-2">
                  ...
                  <div className="relative inline-flex items-center justify-center">
                    <img
                      ...
                      alt=""
                      className="w-[40px] h-[40px] sm:w-[50px] sm:h-[50px] md:w-[93px] md:h-[74px] object-contain"
                    />
                  </div>
                  <span
                    data-animate-item
                ...
                <div className="flex items-center flex-wrap gap-2">
                  <span
                    ...
                    className="home-title-emailprecision text-[#a3a5a8] font-['Inter'] font-bold opacity-50"
                  >
                    With
                  </span>
                  <span
            ...
            <div className="w-full lg:w-auto lg:flex-1 lg:max-w-[626px]">
              <p
                data-animate-item
                style={{ transitionDelay: "0.25s" }}
                className="home-description-emailprecision   text-[#546779] font-['Manrope'] text-left"
              >
